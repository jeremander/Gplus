# Performs vertex nomination on content + context (based on PMI embeddings) using random forests, AdaBoost, logistic regression, and Gaussian Naive Bayes. Obscures one attribute type and does nomination on the desired attribute of that type. Averages precision-by-rank over a number of samples.
